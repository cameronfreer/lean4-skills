...
description: Use when writing or fixing Lean doc comments that use Verso roles. Focuses on resolving doc.verso warnings and keeping hovers precise.
---
...
- You are fixing doc.verso warnings about unresolved code elements or roles.
- You are writing `/-- ... -/` doc comments with inline code.
- You want clean hoverable references in Verso docs.
