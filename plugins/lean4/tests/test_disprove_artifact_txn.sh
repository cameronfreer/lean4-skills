...
run '#print axioms _root_.T_counterexample' append --scope-file "$G" --txn "$TXN9" --role gate --decl T_counterexample_axioms
assert_exit "9b. #print axioms command appended as a gate block" 0
assert_count "9c. probe present once" "$G" "^#print axioms _root_.T_counterexample$" 1
