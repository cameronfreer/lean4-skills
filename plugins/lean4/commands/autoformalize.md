...
- **Docstring policy — Rule C (new-file / new-decl generation).** Session-generated files and declarations may carry module/declaration docstrings from creation; pre-existing declarations retain Rule A (no silent docstring rewrites). New-file module docstrings follow the canonical header template in [mathlib-style.md § 1](../skills/lean4/references/mathlib-style.md#1-file-header-copyright-module-imports-critical).
