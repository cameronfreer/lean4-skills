...
Extended workflow examples for Lean4 plugin agents.

---

## lean4-sorry-filler (Fast Pass)

### Multi-Candidate Generation

```
Understanding sorry at Core.lean:42...

Goal: ⊢ Continuous f

Searching mathlib...
- leansearch: Found `Continuous.comp`, `continuous_const`
- loogle: Found `Continuous → Measurable`
...
Testing candidates via LSP...
- Candidate A: ✓ compiles
- Candidate B: ✓ compiles
- Candidate C: ✗ timeout

Applying shortest (Candidate A)...
✓ Sorry filled
```
...
```
Understanding sorry at Core.lean:156...

Goal: ⊢ ∀ x ∈ S, P x → Q x

Searching mathlib... no direct match

Candidate A (direct):
exact Set.forall_mem_image.mpr h
...
Testing candidates...
- Candidate A: ✗ type mismatch
- Candidate B: ✗ unsolved goal
- Candidate C: ✗ timeout

❌ FAST PASS FAILED

All 3 candidates failed:
- Candidate A: type mismatch (expected Set, got Filter)
- Candidate B: unsolved goal (Q x)
- Candidate C: timeout after 5s

**RECOMMENDATION: Escalate to lean4-sorry-filler-deep**

This sorry needs:
- Statement may need generalization
- Missing intermediate lemma
- Domain expertise in filters
```
